...
function usernameValidation()
{
    ...
    {
        document.getElementById("emptyNameMsg").classList.replace("d-none", "d-block");
        return false
    }
    else
    {
...
function userPasswordValidation()
{
    ...
    {
        document.getElementById("empytPassMsg").classList.replace("d-none", "d-block");
        return false
    } 
    else
    {
...
function userEmailValidation()
{
    ...
    {
        document.getElementById("emptyEmailMsg").classList.replace("d-none", "d-block");
        return false
    }
    else
    {
...
function navbarOptions()
{
    ...
    if(navOptionBtn.getAttribute("aria-expanded") === "true" && navbarSupportedContent.classList.contains("show") === true)
    {
        navOptionBtn.setAttribute("aria-expanded", "false");
        navbarSupportedContent.classList.remove("show");
    }
    else
    {
        navOptionBtn.setAttribute("aria-expanded", "true");
